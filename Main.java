...
public class Main {
    private static List<Album> albums = new ArrayList<Album>(); // Implementing interface (Changed LinkedList to List)
    ...
    public static void main(String[] args) {
        ...
        List<Song> playList = new Vector<>();  // // Implementing interface (Changed LinkedList to List and ArrayList to Vector)
